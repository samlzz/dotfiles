...
if command -v 'eza' &> /dev/null; then
	...
	alias la='eza -a --group-directories-first --icons always'   # all files and dirs
	alias ll='eza -l --group-directories-first --icons always'   # long format
	alias lt='eza -T --group-directories-first --icons always'   # tree listing
	alias lta='eza -aT --group-directories-first --icons --git-ignore' # tree listing of all files and dirs
else
